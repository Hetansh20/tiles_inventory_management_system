...
export default function Navbar({
  ...
  return (
    <header className="sticky top-0 z-30 border-b border-slate-200/50 bg-white/70 px-4 py-4 shadow-[0_4px_30px_rgba(0,0,0,0.02)] backdrop-blur-xl dark:border-slate-800/50 dark:bg-slate-950/70 md:px-6">
      <div className="flex flex-wrap items-center justify-between gap-4">
        <div className="flex items-center gap-4">
          <button
            type="button"
            onClick={onMenuClick}
            className="rounded-xl border border-slate-200/50 bg-white/50 p-2.5 text-slate-600 transition-colors hover:bg-slate-100 dark:border-slate-700/50 dark:bg-slate-800/50 dark:text-slate-300 dark:hover:bg-slate-800 lg:hidden"
          >
            <FiMenu size={18} />
          </button>
        ...
        <div className="flex items-center gap-3 w-full sm:w-auto justify-end">
          <button
            ...
            className="flex flex-1 sm:flex-none items-center gap-2 rounded-xl border border-slate-200/50 bg-slate-50/50 px-4 py-2.5 text-xs font-bold text-slate-500 transition-all hover:bg-slate-100 dark:border-slate-700/50 dark:bg-slate-800/50 dark:text-slate-400 dark:hover:bg-slate-800"
          >
            <FiSearch size={16} />
